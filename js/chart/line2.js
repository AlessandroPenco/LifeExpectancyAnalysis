...
//Read the data
d3.csv(
  "https://raw.githubusercontent.com/AlessandroPenco/LifeExpectancyAnalysis/main/data/myLE-UN-Projections.csv"
).then(function (data) {
  ...
  const lineChart = svgline2.append("g").attr("clip-path", "url(#clip)");
